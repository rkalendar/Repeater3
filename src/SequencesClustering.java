...
public final class SequencesClustering {
    ...
    public SequencesClustering(String[] primers, int sim, boolean t) {
    ...
    private int Clustering12() {
        ...
        for (int j = 0; j < nseq; j++) {
            lx[j] = primers[j].length();
            l = l + lx[j];
            if (lx[j] > kmer) {
                z3[0] = tables.dx[primers[j].charAt(0)];
                z3[1] = tables.dx[primers[j].charAt(1)];
                z3[2] = tables.dx[primers[j].charAt(2)];
                z3[3] = tables.dx[primers[j].charAt(3)];
                z3[4] = tables.dx[primers[j].charAt(4)];
                z3[5] = tables.dx[primers[j].charAt(5)];
                z3[6] = tables.dx[primers[j].charAt(6)];
                z3[7] = tables.dx[primers[j].charAt(7)];
                z3[8] = tables.dx[primers[j].charAt(8)];
                z3[9] = tables.dx[primers[j].charAt(9)];
                z3[10] = tables.dx[primers[j].charAt(10)];
                for (int i = kmer - 1; i < lx[j]; i++) {
                    z3[kmer - 1] = tables.dx[primers[j].charAt(i)];
        ...
        for (int j = 0; j < nseq; j++) {
            if (lx[j] > kmer) {
                String a2 = dna.ComplementDNA(primers[j]);
